...
func commandAssetsConnectShortNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/connect-short.nomad", size: 1071, mode: os.FileMode(420), modTime: time.Unix(1671227707, 0)}
...
func commandAssetsConnectNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/connect.nomad", size: 18126, mode: os.FileMode(420), modTime: time.Unix(1671227707, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func commandAssetsExampleShortNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/example-short.nomad", size: 369, mode: os.FileMode(420), modTime: time.Unix(1671227707, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func commandAssetsExampleNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/example.nomad", size: 16351, mode: os.FileMode(420), modTime: time.Unix(1671227707, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
